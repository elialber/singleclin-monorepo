...
namespace SingleClin.API.Migrations.ApplicationDb
{
    ...
    [Migration("20250908210939_ForceCreateClinicServicesTable")]
    partial class ForceCreateClinicServicesTable
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("SingleClin.API.Data.Models.Service", b =>
                {
                    b.HasOne("SingleClin.API.Data.Models.Clinic", "Clinic")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_clinic_services_clinics_clinic_id");
