...
namespace SingleClin.API.Migrations
{
    ...
    [Migration("20250922162558_FixServiceIsActiveColumn")]
    partial class FixServiceIsActiveColumn
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SingleClin.API.Data.Models.Appointment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("TransactionId")
                        .HasDatabaseName("ix_appointments_transaction_id");
            ...
            modelBuilder.Entity("SingleClin.API.Data.Models.Service", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("SingleClin.API.Data.Models.Appointment", b =>
                {
                    ...
                    b.HasOne("SingleClin.API.Data.Models.Service", "Service")
                        .WithMany()
                    ...
                    b.HasOne("SingleClin.API.Data.Models.Transaction", "Transaction")
                        .WithMany()
                        .HasForeignKey("TransactionId")
                        .HasConstraintName("fk_appointments_transactions_transaction_id");
            ...
            modelBuilder.Entity("SingleClin.API.Data.Models.Service", b =>
                {
                    b.HasOne("SingleClin.API.Data.Models.Clinic", "Clinic")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_services_clinics_clinic_id");
