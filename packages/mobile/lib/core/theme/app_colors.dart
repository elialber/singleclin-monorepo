...
class AppColors {
  ...
  static const Color primaryDark = Color(0xFF5BA0F2); // Slightly lighter for dark mode
  
  // Secondary Colors
  static const Color secondaryLight = Color(0xFF50C878); // Emerald green
  static const Color secondaryDark = Color(0xFF60D888); // Lighter green for dark mode
