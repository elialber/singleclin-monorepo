...
class Service extends Equatable {
  ...
  Service copyWith({
    ...
    return Service(
      ...
      aftercareInstructions: aftercareInstructions ?? this.aftercareInstructions,
  ...
  factory ServicePricing.fromJson(Map<String, dynamic> json) {
    return ServicePricing(
      ...
      package3Sessions: json['package3Sessions'] != null
          ? PackageDeal.fromJson(json['package3Sessions'] as Map<String, dynamic>)
          : null,
      package5Sessions: json['package5Sessions'] != null
          ? PackageDeal.fromJson(json['package5Sessions'] as Map<String, dynamic>)
          : null,
      package10Sessions: json['package10Sessions'] != null
          ? PackageDeal.fromJson(json['package10Sessions'] as Map<String, dynamic>)
          : null,
...
class PackageDeal extends Equatable {
  ...
  String get formattedSavings => 'Economize ${savings}SG (${savingsPercentage.toStringAsFixed(0)}%)';
...
class ServiceAvailability extends Equatable {
  ...
  bool isAvailableAt(TimeOfDay time) {
    ...
    if (unavailableTimes != null) {
      for (final unavailableTime in unavailableTimes!) {
        final unavailableMinutes = unavailableTime.hour * 60 + unavailableTime.minute;
  ...
  List<TimeOfDay> getAvailableTimeSlots(int slotDurationMinutes) {
    ...
    for (int minutes = startMinutes; minutes < endMinutes; minutes += slotDurationMinutes) {
