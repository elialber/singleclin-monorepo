...
class Service extends Equatable {
  const Service({
    ...
    required this.priceInSG, required this.durationMinutes, required this.isActive, required this.requiresConsultation, required this.createdAt, required this.updatedAt, this.subcategory,
    this.imageUrl,
    this.tags = const [],
