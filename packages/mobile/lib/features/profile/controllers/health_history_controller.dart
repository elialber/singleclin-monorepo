...
class HealthHistoryController extends GetxController {
  ...
  List<HealthRecord> get upcomingFollowUps {
    return _records
        .where((record) => record.hasFollowUp && !record.isFollowUpDue)
        .toList()
      ..sort((a, b) {
  ...
  List<HealthRecord> _generateMockRecords() {
    ...
    return [
      HealthRecord(
        ...
        description:
            'Procedimento de limpeza facial realizado com extração de cravos e aplicação de máscara calmante.',
        ...
        isImportant: true,
        tags: const ['estética', 'facial', 'limpeza'],
      ...
      HealthRecord(
        ...
        attachments: const ['hemograma_202401.pdf'],
        tags: const ['exame', 'sangue', 'rotina'],
      ...
      HealthRecord(
        ...
        description:
            'Avaliação de pele e orientações para cuidados específicos.',
        ...
        tags: const ['dermatologia', 'consulta', 'pele'],
      ...
      HealthRecord(
        ...
        tags: const ['vacina', 'gripe', 'prevenção'],
